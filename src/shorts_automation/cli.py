...
from .renderer import render_all, render_video_package
...
def main(argv: list[str] | None = None) -> int:
    ...
    daily_parser.add_argument("--tts-provider", default=os.getenv("TTS_PROVIDER", "mock"), choices=["mock", "elevenlabs", "off"])
    ...
    generate_parser.add_argument("--tts-provider", default=os.getenv("TTS_PROVIDER", "mock"), choices=["mock", "elevenlabs", "off"])
    ...
    tts_parser.add_argument("--tts-provider", default=os.getenv("TTS_PROVIDER", "mock"), choices=["mock", "elevenlabs", "off"])
    ...
    if args.command == "render-video":
        result = render_video_package(Path(args.video_dir))
    ...
    if args.command == "generate-video":
        ...
        render_result = render_all(output_dir / "videos") if args.render else None
        print(
            json.dumps(
                {
